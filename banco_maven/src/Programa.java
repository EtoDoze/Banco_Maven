...
public class Programa {
    public static void main(String[] args) {
        ...
        System.out.println("CNPJ do titular: " + ((PessoaJuridica) cc.getTitular()).getCnpj());// fazendo o casting para
        ...
        System.out.println("CPF do titular: " + ((PessoaFisica) cp.getTitular()).getCpf()); // fazendo o casting para
                                                                                            // pessoa fisica para
                                                                                            // acessar o cpf
